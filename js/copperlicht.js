...
CL3D.Renderer.prototype.nextHighestPowerOfTwo = function(a) {--a;
    ...
    try {
        ...
        case 3:
            if (this.PlayedCount) {} else {
                if (this.TheSound) {
                    this.startSound(true); ++PlayedCount
                }
            }
            break
        }
...
CL3D.AnimatorCollisionResponse.prototype.testTriangleIntersection = function(s, y) {
    ...
    if (k) {
        ...
        if (!s.foundCollision || D < s.nearestDistance) {
            ...
            s.intersectionTriangle = y; ++s.triangleHits
        }
    }
};
...
CL3D.FlaceLoader = function() {
    ...
    this.ReadAnimator = function(t, y) {
        if (!t) {
            this.SkipToNextTag();
            return
        }
        ...
        case 105:
            ...
            break;
        case 106:
            var k = new CL3D.AnimatorFollowPath(y);
            ...
            break;
        case 107:
            var j = new CL3D.AnimatorOnClick(y, this.CursorControl);
            j.BoundingBoxTestOnly = this.Data.readBoolean();
            j.CollidesWithWorld = this.Data.readBoolean();
            this.Data.readInt();
            j.TheActionHandler = this.ReadActionHandlerSection(y);
            z = j;
            break;
        case 108:
            var e = new CL3D.AnimatorOnProximity(y);
            ...
            this.Data.readInt();
            e.TheActionHandler = this.ReadActionHandlerSection(y);
            z = e;
            break;
        case 109:
            ...
            break;
        case 110:
            var j = new CL3D.AnimatorOnMove(y, this.CursorControl);
            j.BoundingBoxTestOnly = this.Data.readBoolean();
            j.CollidesWithWorld = this.Data.readBoolean();
            this.Data.readInt();
            j.ActionHandlerOnLeave = this.ReadActionHandlerSection(y);
            j.ActionHandlerOnEnter = this.ReadActionHandlerSection(y);
            z = j;
            break;
        case 111:
            var r = new CL3D.AnimatorTimer(y);
            r.TickEverySeconds = this.Data.readInt();
            this.Data.readInt();
            r.TheActionHandler = this.ReadActionHandlerSection(y);
            z = r;
            break;
        case 112:
            var x = new CL3D.AnimatorOnKeyPress(y, this.CursorControl);
            x.KeyPressType = this.Data.readInt();
            x.KeyCode = this.Data.readInt();
            x.IfCameraOnlyDoIfActive = this.Data.readBoolean();
            this.Data.readInt();
            x.TheActionHandler = this.ReadActionHandlerSection(y);
            z = x;
            break;
        case 113:
            var h = new CL3D.AnimatorGameAI(y);
            ...
            this.Data.readInt();
            h.ActionHandlerOnAttack = this.ReadActionHandlerSection(y);
            h.ActionHandlerOnActivate = this.ReadActionHandlerSection(y);
            h.ActionHandlerOnHit = this.ReadActionHandlerSection(y);
            h.ActionHandlerOnDie = this.ReadActionHandlerSection(y);
            z = h;
            break;
        case 114:
            var w = new CL3D.Animator3rdPersonCamera();
            w.SceneNodeIDToFollow = this.Data.readInt();
            w.AdditionalRotationForLooking = this.Read3DVectF();
            w.FollowMode = this.Data.readInt();
            w.FollowSmoothingSpeed = this.Data.readFloat();
            w.TargetHeight = this.Data.readFloat();
            var g = this.Data.readInt();
            if (g & 1) {
                w.CollidesWithWorld = true
            } else {
                w.CollidesWithWorld = false
            }
            z = w;
            break;
        case 115:
            var m = new CL3D.AnimatorKeyboardControlled(y, this.CursorControl);
            this.Data.readInt();
...
CL3D.OctTreeTriangleSelector.prototype.constructTree = function(c) {++this.DebugNodeCount;
